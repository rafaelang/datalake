...
- [Pipeline](#Pipeline)
    - [Streaming Data Restructuring and Organization](#Streaming-Data-Restructuring-and-Organization)
        - [Getting Raw Checkout Data on Amazon S3](#Getting-Raw-Checkout-Data-on-Amazon-S3)
        - [Notification, from the SNS, about the new data obtained](#Notification,-from-the-SNS,-about-the-new-data-gotten)
        - [Raw data preprocessing with AWS Lambda](#Raw-data-preprocessing-with-AWS-Lambda)
        - [Writing structured data in a new bucket in S3](#Writing-structured-data-in-a-new-bucket-in-S3)
        - [Structured Data Schema Inference with Glue's Crawler](#Structured-Data-Schema-Inference-with-Glue's-Crawler)
        - [Notification, from the SNS, about structured data](#Notification,-from-the-SNS,-about-structured-data)
        - [Partitioning and Storage Data with Amazon Kinesis Firehose](#Partitioning-and-Storage-Data-with-Amazon-Kinesis-Firehose)
    - [Batch Data Partitioning](#Batch-Data-Partitioning)
        - [Defining a execution routine with Amazon CloudWatch](#Defining-a-execution-routine-with-Amazon-CloudWatch)
        - [Creation of a cluster from Lambda for partitioning last-minute data](#Creation-of-a-cluster-from-Lambda-for-partitioning-last-minute-data)
        - [Data Partitioning and Storage with AWS EMR](#Data-Partitioning-and-Storage-with-AWS-EMR)
        - [Partitioned Data Catalog](#Partitioned-Data-Catalog)
...
### **Getting Raw Checkout Data on Amazon S3**
...
### **Notification, from the SNS, about the new data gotten**
...
### **Raw data preprocessing with AWS Lambda**
...
### **Writing structured data in a new bucket in S3**
...
### **Structured Data Schema Inference with Glue's Crawler**
...
### **Notification, from the SNS, about structured data**
...
### **Partitioning and Storage Data with Amazon Kinesis Firehose**
...
### **Defining a execution routine with Amazon CloudWatch**
...
### **Creation of a cluster from Lambda for partitioning last-minute data**
...
### **Data Partitioning and Storage with AWS EMR**
